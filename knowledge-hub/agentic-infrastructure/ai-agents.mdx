...
When you schedule your first messages, it can take up to 48 hours to see results in aampe because you put your agents to work, and they start analyzing and clustering the data to send messages.
